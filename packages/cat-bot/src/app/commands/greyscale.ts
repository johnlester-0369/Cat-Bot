/**
 * /greyscale — Greyscale Avatar
 *
 * Fetches the target user's avatar (mention → replied-to user → self) and
 * passes it to the PopCat /v2/greyscale endpoint. The API returns a
 * greyscale image which is sent as a Buffer attachment.
 *
...
export const config: CommandConfig = {
  ...
  role: Role.ANYONE,
  author: 'AjiroDesu',
  description: 'Apply a greyscale filter to a user\'s avatar.',
  category: 'fun',
  usage: '[@user]',
  cooldown: 5,
  hasPrefix: true,
