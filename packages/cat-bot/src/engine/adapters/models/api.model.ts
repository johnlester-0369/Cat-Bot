...
export class UnifiedApi {
  ...
  async sendMessage(
    ...
    logger.debug('[UnifiedApi] sendMessage called', {
  ...
  async unsendMessage(_messageID: string): Promise<void> {
    logger.debug('[UnifiedApi] unsendMessage called', {
      platform: this.platform,
  ...
  async getUserInfo(_userIds: string[]): Promise<Record<string, UserInfo>> {
    logger.debug('[UnifiedApi] getUserInfo called', {
      platform: this.platform,
      count: _userIds.length,
    });
    throw new Error(
  ...
  async setGroupName(_threadID: string, _name: string): Promise<void> {
    logger.debug('[UnifiedApi] setGroupName called', {
      platform: this.platform,
      threadID: _threadID,
    });
    throw new Error(
  ...
  async setGroupImage(
    ...
    logger.debug('[UnifiedApi] setGroupImage called', {
      platform: this.platform,
      threadID: _threadID,
    });
    throw new Error(
  ...
  async reactToMessage(
    ...
    logger.debug('[UnifiedApi] reactToMessage called', {
      platform: this.platform,
      threadID: _threadID,
      messageID: _messageID,
      emoji: _emoji,
  ...
  async removeGroupImage(_threadID: string): Promise<void> {
    logger.debug('[UnifiedApi] removeGroupImage called', {
      platform: this.platform,
      threadID: _threadID,
    });
    throw new Error(
  ...
  async addUserToGroup(_threadID: string, _userID: string): Promise<void> {
    logger.debug('[UnifiedApi] addUserToGroup called', {
      platform: this.platform,
      threadID: _threadID,
      userID: _userID,
    });
  ...
  async removeUserFromGroup(_threadID: string, _userID: string): Promise<void> {
    logger.debug('[UnifiedApi] removeUserFromGroup called', {
      platform: this.platform,
      threadID: _threadID,
      userID: _userID,
    });
  ...
  async setGroupReaction(_threadID: string, _emoji: string): Promise<void> {
    logger.debug('[UnifiedApi] setGroupReaction called', {
      platform: this.platform,
      threadID: _threadID,
      emoji: _emoji,
    });
  ...
  async setNickname(
    ...
    logger.debug('[UnifiedApi] setNickname called', {
      platform: this.platform,
      threadID: _threadID,
      userID: _userID,
    });
  ...
  async replyMessage(
    ...
    logger.debug('[UnifiedApi] replyMessage called', {
      platform: this.platform,
      threadID: _threadID,
    });
    throw new Error(
  ...
  async getFullThreadInfo(_threadID: string): Promise<UnifiedThreadInfo> {
    logger.debug('[UnifiedApi] getFullThreadInfo called', {
      platform: this.platform,
      threadID: _threadID,
    });
    throw new Error(
  ...
  async getFullUserInfo(_userID: string): Promise<UnifiedUserInfo> {
    logger.debug('[UnifiedApi] getFullUserInfo called', {
      platform: this.platform,
      userID: _userID,
    });
    throw new Error(
  ...
  async getUserName(_userID: string): Promise<string> {
    logger.debug('[UnifiedApi] getUserName called', {
      platform: this.platform,
      userID: _userID,
    });
    throw new Error(
      `getUserName not implemented on platform: ${this.platform}`,
    );
  }
  ...
  async getThreadName(_threadID: string): Promise<string> {
    logger.debug('[UnifiedApi] getThreadName called', {
      platform: this.platform,
      threadID: _threadID,
    });
    throw new Error(
