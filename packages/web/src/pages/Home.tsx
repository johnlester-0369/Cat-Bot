          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  Cat-Bot is a unified chatbot framework that runs across Discord,
                  Telegram, Facebook Page, and Facebook Messenger — all from a single
                  codebase. Manage multiple independent bot sessions from one powerful
                  dashboard.
                </p>
              </div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col gap-14">
          <div className="flex flex-col gap-3 text-center">
            ...
            <p className="text-body-lg text-on-surface-variant max-w-xl mx-auto">
              Built for developers and operators who want one framework for every
              major chat platform — without compromises.
            </p>
          </div>
